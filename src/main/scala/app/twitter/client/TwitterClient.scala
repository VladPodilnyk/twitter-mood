...
object TwitterClient {
  def mkClient(component: TwitterComponent): Task[TwitterClient] = Task.eval(new Impl(component))

  private final class Impl(twitter: TwitterComponent) extends TwitterClient {
